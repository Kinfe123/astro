...
## Purpose and Scope
Astro is easiest to understand when the major subsystems are visible first. This page explains the real runtime areas in the repository, how they connect, and which reader-facing docs pages to use next.
## Primary Subsystems
...
## Runtime Surfaces
- Frameworks and runtimes appear in this repository through Astro, Gin, SvelteKit.
- The package surface starts from `astro` and any additional exported entrypoints.
- Request or route handling is grounded in 6 source files.
- CLI workflows are present with 15 detected flags.
